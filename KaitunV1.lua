--[[
	...
	3. Added Auto Awaken Fruit
	4. Added Item Finder Fully
	5. Fixed Auto Dough Awaken ( Not Have Remote ) 
--]]
	...
	while task.wait(0.1) do
		if getgenv().KaitunConfig["Start Farm"] and Ready_To_Farm then
			local succ,err = pcall(function()
				...
				local Alt_Function = Handle_Melee_Function() or Handle_Sea_Function() or Farm_All_Item() or DoRaid
